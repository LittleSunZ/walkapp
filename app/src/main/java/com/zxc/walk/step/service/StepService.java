package com.zxc.walk.step.service;
...
import com.zxc.walk.step.accelerometer.StepCount;
import com.zxc.walk.step.accelerometer.StepValuePassListener;
import com.zxc.walk.step.bean.StepData;
import com.zxc.walk.step.utils.DbUtils;
...
//        mNotificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        ...
        //设置通知铃声
        Notification notification = mBuilder.setTicker("您有新的消息")
                ...
                .setPriority(NotificationCompat.PRIORITY_MIN) // 设置通知的优先级
                .setSound(null)
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private int preStepCount;

    /***
     * 获取上一次上传的步数
     */
    public int getPreStepCount(){
        return preStepCount;
    }

    public void setPreStepCount(int preStepCount){
        this.preStepCount = preStepCount;
    }
